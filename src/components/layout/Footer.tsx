        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center space-x-4 mt-6">
              ...
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-threadGold">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-threadGold">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {categories.map((category) => (
                <li key={category.id}>
                  <Link to={`/category/${category.slug}`} className="text-gray-300 hover:text-threadGold transition-colors">
                    {category.name}
                  </Link>
                </li>
              ))}
